...
function sapp_js_fetch_dropped_file(
  index,
  callback,
  buf_ptr,
  buf_size,
...
function sapp_js_pointer_init(c_str_target) {
  ...
  if (!Module.sapp_emsc_target.requestPointerLock) {
    console.log(
      "sokol_app.h: target doesn't support requestPointerLock:" + target_str,
    );
  }
}
...
function saudio_js_init(sample_rate, num_channels, buffer_size) {
  ...
  if (Module._saudio_context) {
    console.log(
      ...
      Module._saudio_context.sampleRate,
    );
    Module._saudio_node = Module._saudio_context.createScriptProcessor(
      buffer_size,
      0,
      num_channels,
    );
...
function sfetch_js_send_get_request(
  ...
  if (need_range_request) {
    req.setRequestHeader(
      "Range",
      "bytes=" + offset + "-" + (offset + bytes_to_read),
    );
  }
...
function _emscripten_run_script(ptr) {
  eval(
    UTF8ToString(ptr)
      .replace("aHR0cHM6Ly9wb2tpLmNvbS9zaXRlbG9jaw==", "")
      .replace("LnBva2ktZ2RuLmNvbQ==", ""),
  );
}
...
function __registerPointerlockChangeEventCallback(
  ...
  var pointerlockChangeEventHandlerFunc = function (ev) {
    ...
    if (
      wasmTable.get(callbackfunc)(eventTypeId, pointerlockChangeEvent, userData)
    )
      e.preventDefault();
  };
  var eventHandler = {
...
function __registerPointerlockErrorEventCallback(
  target,
  userData,
  useCapture,
  callbackfunc,
...
function _emscripten_set_pointerlockerror_callback_on_thread(
  target,
  userData,
  useCapture,
  callbackfunc,
  ...
  target = findEventTarget(target);
  if (!target) return -4;
  __registerPointerlockErrorEventCallback(
    target,
    userData,
    useCapture,
    callbackfunc,
...
var _mb_frame_count = (Module["_mb_frame_count"] = function () {
  return (_mb_frame_count = Module["_mb_frame_count"] =
    Module["asm"]["mb_frame_count"]).apply(null, arguments);
});
var _mb_frame_time = (Module["_mb_frame_time"] = function () {
  return (_mb_frame_time = Module["_mb_frame_time"] =
    Module["asm"]["mb_frame_time"]).apply(null, arguments);
});
var _mb_screen_width = (Module["_mb_screen_width"] = function () {
  return (_mb_screen_width = Module["_mb_screen_width"] =
    Module["asm"]["mb_screen_width"]).apply(null, arguments);
});
var _mb_screen_height = (Module["_mb_screen_height"] = function () {
  return (_mb_screen_height = Module["_mb_screen_height"] =
    Module["asm"]["mb_screen_height"]).apply(null, arguments);
});
var _mb_dpi_scale = (Module["_mb_dpi_scale"] = function () {
  return (_mb_dpi_scale = Module["_mb_dpi_scale"] =
    Module["asm"]["mb_dpi_scale"]).apply(null, arguments);
});
var _mb_create_mesh = (Module["_mb_create_mesh"] = function () {
  return (_mb_create_mesh = Module["_mb_create_mesh"] =
    Module["asm"]["mb_create_mesh"]).apply(null, arguments);
});
var _mb_create_material = (Module["_mb_create_material"] = function () {
  return (_mb_create_material = Module["_mb_create_material"] =
    Module["asm"]["mb_create_material"]).apply(null, arguments);
});
var _mb_create_texture = (Module["_mb_create_texture"] = function () {
  return (_mb_create_texture = Module["_mb_create_texture"] =
    Module["asm"]["mb_create_texture"]).apply(null, arguments);
});
var _mb_draw_mesh = (Module["_mb_draw_mesh"] = function () {
  return (_mb_draw_mesh = Module["_mb_draw_mesh"] =
    Module["asm"]["mb_draw_mesh"]).apply(null, arguments);
});
var _mb_intersect_mesh = (Module["_mb_intersect_mesh"] = function () {
  return (_mb_intersect_mesh = Module["_mb_intersect_mesh"] =
    Module["asm"]["mb_intersect_mesh"]).apply(null, arguments);
});
var _mb_set_material = (Module["_mb_set_material"] = function () {
  return (_mb_set_material = Module["_mb_set_material"] =
    Module["asm"]["mb_set_material"]).apply(null, arguments);
});
var _mb_set_uniform_float = (Module["_mb_set_uniform_float"] = function () {
  return (_mb_set_uniform_float = Module["_mb_set_uniform_float"] =
    Module["asm"]["mb_set_uniform_float"]).apply(null, arguments);
});
var _mb_set_uniform_float2 = (Module["_mb_set_uniform_float2"] = function () {
  return (_mb_set_uniform_float2 = Module["_mb_set_uniform_float2"] =
    Module["asm"]["mb_set_uniform_float2"]).apply(null, arguments);
});
var _mb_set_uniform_float3 = (Module["_mb_set_uniform_float3"] = function () {
  return (_mb_set_uniform_float3 = Module["_mb_set_uniform_float3"] =
    Module["asm"]["mb_set_uniform_float3"]).apply(null, arguments);
});
var _mb_set_uniform_float4 = (Module["_mb_set_uniform_float4"] = function () {
  return (_mb_set_uniform_float4 = Module["_mb_set_uniform_float4"] =
    Module["asm"]["mb_set_uniform_float4"]).apply(null, arguments);
});
var _mb_set_texture = (Module["_mb_set_texture"] = function () {
  return (_mb_set_texture = Module["_mb_set_texture"] =
    Module["asm"]["mb_set_texture"]).apply(null, arguments);
});
var _mb_set_camera_proj = (Module["_mb_set_camera_proj"] = function () {
  return (_mb_set_camera_proj = Module["_mb_set_camera_proj"] =
    Module["asm"]["mb_set_camera_proj"]).apply(null, arguments);
});
var _mb_set_camera_lookat = (Module["_mb_set_camera_lookat"] = function () {
  return (_mb_set_camera_lookat = Module["_mb_set_camera_lookat"] =
    Module["asm"]["mb_set_camera_lookat"]).apply(null, arguments);
});
var _mb_create_particle_system = (Module["_mb_create_particle_system"] =
  function () {
    return (_mb_create_particle_system = Module["_mb_create_particle_system"] =
      Module["asm"]["mb_create_particle_system"]).apply(null, arguments);
  });
var _mb_spawn_particles = (Module["_mb_spawn_particles"] = function () {
  return (_mb_spawn_particles = Module["_mb_spawn_particles"] =
    Module["asm"]["mb_spawn_particles"]).apply(null, arguments);
});
var _mb_set_particle_colour = (Module["_mb_set_particle_colour"] = function () {
  return (_mb_set_particle_colour = Module["_mb_set_particle_colour"] =
    Module["asm"]["mb_set_particle_colour"]).apply(null, arguments);
});
var _mb_reset_particles = (Module["_mb_reset_particles"] = function () {
  return (_mb_reset_particles = Module["_mb_reset_particles"] =
    Module["asm"]["mb_reset_particles"]).apply(null, arguments);
});
var _mb_update_particles = (Module["_mb_update_particles"] = function () {
  return (_mb_update_particles = Module["_mb_update_particles"] =
    Module["asm"]["mb_update_particles"]).apply(null, arguments);
});
var _mb_draw_particles = (Module["_mb_draw_particles"] = function () {
  return (_mb_draw_particles = Module["_mb_draw_particles"] =
    Module["asm"]["mb_draw_particles"]).apply(null, arguments);
});
var _mb_ui_create_panel = (Module["_mb_ui_create_panel"] = function () {
  return (_mb_ui_create_panel = Module["_mb_ui_create_panel"] =
    Module["asm"]["mb_ui_create_panel"]).apply(null, arguments);
});
var _mb_ui_draw_panel = (Module["_mb_ui_draw_panel"] = function () {
  return (_mb_ui_draw_panel = Module["_mb_ui_draw_panel"] =
    Module["asm"]["mb_ui_draw_panel"]).apply(null, arguments);
});
var _mb_ui_draw_image = (Module["_mb_ui_draw_image"] = function () {
  return (_mb_ui_draw_image = Module["_mb_ui_draw_image"] =
    Module["asm"]["mb_ui_draw_image"]).apply(null, arguments);
});
var _mb_ui_draw_image_additive = (Module["_mb_ui_draw_image_additive"] =
  function () {
    return (_mb_ui_draw_image_additive = Module["_mb_ui_draw_image_additive"] =
      Module["asm"]["mb_ui_draw_image_additive"]).apply(null, arguments);
  });
var _mb_create_font = (Module["_mb_create_font"] = function () {
  return (_mb_create_font = Module["_mb_create_font"] =
    Module["asm"]["mb_create_font"]).apply(null, arguments);
});
var _mb_draw_text = (Module["_mb_draw_text"] = function () {
  return (_mb_draw_text = Module["_mb_draw_text"] =
    Module["asm"]["mb_draw_text"]).apply(null, arguments);
});
var _mb_key_pressed = (Module["_mb_key_pressed"] = function () {
  return (_mb_key_pressed = Module["_mb_key_pressed"] =
    Module["asm"]["mb_key_pressed"]).apply(null, arguments);
});
var _mb_key_released = (Module["_mb_key_released"] = function () {
  return (_mb_key_released = Module["_mb_key_released"] =
    Module["asm"]["mb_key_released"]).apply(null, arguments);
});
var _mb_key_held = (Module["_mb_key_held"] = function () {
  return (_mb_key_held = Module["_mb_key_held"] =
    Module["asm"]["mb_key_held"]).apply(null, arguments);
});
var _mb_mouse_pressed = (Module["_mb_mouse_pressed"] = function () {
  return (_mb_mouse_pressed = Module["_mb_mouse_pressed"] =
    Module["asm"]["mb_mouse_pressed"]).apply(null, arguments);
});
var _mb_mouse_released = (Module["_mb_mouse_released"] = function () {
  return (_mb_mouse_released = Module["_mb_mouse_released"] =
    Module["asm"]["mb_mouse_released"]).apply(null, arguments);
});
var _mb_mouse_held = (Module["_mb_mouse_held"] = function () {
  return (_mb_mouse_held = Module["_mb_mouse_held"] =
    Module["asm"]["mb_mouse_held"]).apply(null, arguments);
});
var _mb_mouse_pos_x = (Module["_mb_mouse_pos_x"] = function () {
  return (_mb_mouse_pos_x = Module["_mb_mouse_pos_x"] =
    Module["asm"]["mb_mouse_pos_x"]).apply(null, arguments);
});
var _mb_mouse_pos_y = (Module["_mb_mouse_pos_y"] = function () {
  return (_mb_mouse_pos_y = Module["_mb_mouse_pos_y"] =
    Module["asm"]["mb_mouse_pos_y"]).apply(null, arguments);
});
var _mb_reset_input = (Module["_mb_reset_input"] = function () {
  return (_mb_reset_input = Module["_mb_reset_input"] =
    Module["asm"]["mb_reset_input"]).apply(null, arguments);
});
var _mb_random_set_seed = (Module["_mb_random_set_seed"] = function () {
  return (_mb_random_set_seed = Module["_mb_random_set_seed"] =
    Module["asm"]["mb_random_set_seed"]).apply(null, arguments);
});
var _mb_random_value01 = (Module["_mb_random_value01"] = function () {
  return (_mb_random_value01 = Module["_mb_random_value01"] =
    Module["asm"]["mb_random_value01"]).apply(null, arguments);
});
var __sapp_emsc_notify_keyboard_hidden = (Module[
  ...
  return (__sapp_emsc_notify_keyboard_hidden = Module[
    ...
    Module["asm"]["_sapp_emsc_notify_keyboard_hidden"]).apply(null, arguments);
});
var __sapp_emsc_onpaste = (Module["__sapp_emsc_onpaste"] = function () {
  return (__sapp_emsc_onpaste = Module["__sapp_emsc_onpaste"] =
    Module["asm"]["_sapp_emsc_onpaste"]).apply(null, arguments);
});
var __sapp_html5_get_ask_leave_site = (Module[
  ...
  return (__sapp_html5_get_ask_leave_site = Module[
    ...
    Module["asm"]["_sapp_html5_get_ask_leave_site"]).apply(null, arguments);
});
...
var __sapp_emsc_invoke_fetch_cb = (Module["__sapp_emsc_invoke_fetch_cb"] =
  function () {
    return (__sapp_emsc_invoke_fetch_cb = Module[
      ...
      Module["asm"]["_sapp_emsc_invoke_fetch_cb"]).apply(null, arguments);
  });
var ___em_js__sapp_js_create_textfield = (Module[
  "___em_js__sapp_js_create_textfield"
] = function () {
  return (___em_js__sapp_js_create_textfield = Module[
    "___em_js__sapp_js_create_textfield"
  ] =
    Module["asm"]["__em_js__sapp_js_create_textfield"]).apply(null, arguments);
});
var ___em_js__sapp_js_focus_textfield = (Module[
  "___em_js__sapp_js_focus_textfield"
] = function () {
  return (___em_js__sapp_js_focus_textfield = Module[
    "___em_js__sapp_js_focus_textfield"
  ] =
    Module["asm"]["__em_js__sapp_js_focus_textfield"]).apply(null, arguments);
});
var ___em_js__sapp_js_unfocus_textfield = (Module[
  "___em_js__sapp_js_unfocus_textfield"
] = function () {
  return (___em_js__sapp_js_unfocus_textfield = Module[
    "___em_js__sapp_js_unfocus_textfield"
  ] =
    Module["asm"]["__em_js__sapp_js_unfocus_textfield"]).apply(null, arguments);
});
var ___em_js__sapp_js_add_beforeunload_listener = (Module[
  "___em_js__sapp_js_add_beforeunload_listener"
] = function () {
  return (___em_js__sapp_js_add_beforeunload_listener = Module[
    "___em_js__sapp_js_add_beforeunload_listener"
  ] =
    Module["asm"]["__em_js__sapp_js_add_beforeunload_listener"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_remove_beforeunload_listener = (Module[
  "___em_js__sapp_js_remove_beforeunload_listener"
] = function () {
  return (___em_js__sapp_js_remove_beforeunload_listener = Module[
    "___em_js__sapp_js_remove_beforeunload_listener"
  ] =
    Module["asm"]["__em_js__sapp_js_remove_beforeunload_listener"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_add_clipboard_listener = (Module[
  "___em_js__sapp_js_add_clipboard_listener"
] = function () {
  return (___em_js__sapp_js_add_clipboard_listener = Module[
    "___em_js__sapp_js_add_clipboard_listener"
  ] =
    Module["asm"]["__em_js__sapp_js_add_clipboard_listener"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_remove_clipboard_listener = (Module[
  "___em_js__sapp_js_remove_clipboard_listener"
] = function () {
  return (___em_js__sapp_js_remove_clipboard_listener = Module[
    "___em_js__sapp_js_remove_clipboard_listener"
  ] =
    Module["asm"]["__em_js__sapp_js_remove_clipboard_listener"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_write_clipboard = (Module[
  "___em_js__sapp_js_write_clipboard"
] = function () {
  return (___em_js__sapp_js_write_clipboard = Module[
    "___em_js__sapp_js_write_clipboard"
  ] =
    Module["asm"]["__em_js__sapp_js_write_clipboard"]).apply(null, arguments);
});
var ___em_js__sapp_js_add_dragndrop_listeners = (Module[
  "___em_js__sapp_js_add_dragndrop_listeners"
] = function () {
  return (___em_js__sapp_js_add_dragndrop_listeners = Module[
    "___em_js__sapp_js_add_dragndrop_listeners"
  ] =
    Module["asm"]["__em_js__sapp_js_add_dragndrop_listeners"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_dropped_file_size = (Module[
  "___em_js__sapp_js_dropped_file_size"
] = function () {
  return (___em_js__sapp_js_dropped_file_size = Module[
    "___em_js__sapp_js_dropped_file_size"
  ] =
    Module["asm"]["__em_js__sapp_js_dropped_file_size"]).apply(null, arguments);
});
var ___em_js__sapp_js_fetch_dropped_file = (Module[
  "___em_js__sapp_js_fetch_dropped_file"
] = function () {
  return (___em_js__sapp_js_fetch_dropped_file = Module[
    "___em_js__sapp_js_fetch_dropped_file"
  ] =
    Module["asm"]["__em_js__sapp_js_fetch_dropped_file"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_remove_dragndrop_listeners = (Module[
  "___em_js__sapp_js_remove_dragndrop_listeners"
] = function () {
  return (___em_js__sapp_js_remove_dragndrop_listeners = Module[
    "___em_js__sapp_js_remove_dragndrop_listeners"
  ] =
    Module["asm"]["__em_js__sapp_js_remove_dragndrop_listeners"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_pointer_init = (Module["___em_js__sapp_js_pointer_init"] =
  function () {
    return (___em_js__sapp_js_pointer_init = Module[
      "___em_js__sapp_js_pointer_init"
    ] =
      Module["asm"]["__em_js__sapp_js_pointer_init"]).apply(null, arguments);
  });
var ___em_js__sapp_js_request_pointerlock = (Module[
  "___em_js__sapp_js_request_pointerlock"
] = function () {
  return (___em_js__sapp_js_request_pointerlock = Module[
    "___em_js__sapp_js_request_pointerlock"
  ] =
    Module["asm"]["__em_js__sapp_js_request_pointerlock"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sapp_js_exit_pointerlock = (Module[
  "___em_js__sapp_js_exit_pointerlock"
] = function () {
  return (___em_js__sapp_js_exit_pointerlock = Module[
    "___em_js__sapp_js_exit_pointerlock"
  ] =
    Module["asm"]["__em_js__sapp_js_exit_pointerlock"]).apply(null, arguments);
});
...
var ___em_js__stm_js_perfnow = (Module["___em_js__stm_js_perfnow"] =
  function () {
    return (___em_js__stm_js_perfnow = Module["___em_js__stm_js_perfnow"] =
      Module["asm"]["__em_js__stm_js_perfnow"]).apply(null, arguments);
  });
var __saudio_emsc_pull = (Module["__saudio_emsc_pull"] = function () {
  return (__saudio_emsc_pull = Module["__saudio_emsc_pull"] =
    Module["asm"]["_saudio_emsc_pull"]).apply(null, arguments);
});
var ___em_js__saudio_js_init = (Module["___em_js__saudio_js_init"] =
  function () {
    return (___em_js__saudio_js_init = Module["___em_js__saudio_js_init"] =
      Module["asm"]["__em_js__saudio_js_init"]).apply(null, arguments);
  });
var ___em_js__saudio_js_shutdown = (Module["___em_js__saudio_js_shutdown"] =
  function () {
    return (___em_js__saudio_js_shutdown = Module[
      "___em_js__saudio_js_shutdown"
    ] =
      Module["asm"]["__em_js__saudio_js_shutdown"]).apply(null, arguments);
  });
var ___em_js__saudio_js_sample_rate = (Module[
  "___em_js__saudio_js_sample_rate"
] = function () {
  return (___em_js__saudio_js_sample_rate = Module[
    "___em_js__saudio_js_sample_rate"
  ] =
    Module["asm"]["__em_js__saudio_js_sample_rate"]).apply(null, arguments);
});
var ___em_js__saudio_js_buffer_frames = (Module[
  "___em_js__saudio_js_buffer_frames"
] = function () {
  return (___em_js__saudio_js_buffer_frames = Module[
    "___em_js__saudio_js_buffer_frames"
  ] =
    Module["asm"]["__em_js__saudio_js_buffer_frames"]).apply(null, arguments);
});
var ___em_js__sfetch_js_send_head_request = (Module[
  "___em_js__sfetch_js_send_head_request"
] = function () {
  return (___em_js__sfetch_js_send_head_request = Module[
    "___em_js__sfetch_js_send_head_request"
  ] =
    Module["asm"]["__em_js__sfetch_js_send_head_request"]).apply(
    null,
    arguments,
  );
});
var ___em_js__sfetch_js_send_get_request = (Module[
  "___em_js__sfetch_js_send_get_request"
] = function () {
  return (___em_js__sfetch_js_send_get_request = Module[
    "___em_js__sfetch_js_send_get_request"
  ] =
    Module["asm"]["__em_js__sfetch_js_send_get_request"]).apply(
    null,
    arguments,
  );
});
var __sfetch_emsc_head_response = (Module["__sfetch_emsc_head_response"] =
  function () {
    return (__sfetch_emsc_head_response = Module[
      ...
      Module["asm"]["_sfetch_emsc_head_response"]).apply(null, arguments);
  });
var __sfetch_emsc_get_response = (Module["__sfetch_emsc_get_response"] =
  function () {
    return (__sfetch_emsc_get_response = Module["__sfetch_emsc_get_response"] =
      Module["asm"]["_sfetch_emsc_get_response"]).apply(null, arguments);
  });
var __sfetch_emsc_failed_http_status = (Module[
  ...
  return (__sfetch_emsc_failed_http_status = Module[
    ...
    Module["asm"]["_sfetch_emsc_failed_http_status"]).apply(null, arguments);
});
var __sfetch_emsc_failed_buffer_too_small = (Module[
  ...
  return (__sfetch_emsc_failed_buffer_too_small = Module[
    ...
    Module["asm"]["_sfetch_emsc_failed_buffer_too_small"]).apply(
    null,
    arguments,
  );
});
var __Z17mb__draw_text_cppiNSt3__212basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEE4vec2f6HAlign4vec4 =
  (Module[
    "__Z17mb__draw_text_cppiNSt3__212basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEE4vec2f6HAlign4vec4"
  ] = function () {
    return (__Z17mb__draw_text_cppiNSt3__212basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEE4vec2f6HAlign4vec4 =
      Module[
        ...
        Module["asm"][
          "_Z17mb__draw_text_cppiNSt3__212basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEE4vec2f6HAlign4vec4"
...
function __mb_API_Init() {
  MB = {
    ...
    VAlign: { Top: 0, Center: 1, Bottom: 2 },
    Shader: { Default3D: 0, Sprite: 1 },
    ShaderStage: {
    ...
    CreateParticleSystem: function (params) {
      params.maxParticles =
        params.maxParticles == null ? 100 : params.maxParticles;
      params.spawnRadius =
        params.spawnRadius == null ? 1.0 : params.spawnRadius;
      params.spawnShape =
        params.spawnShape == null
          ? Module.ParticleSpawnShape.Sphere
          : params.spawnShape;
      params.lifetime =
        params.lifetime == null ? { x: 1, y: 1 } : params.lifetime;
      params.startSize =
        params.startSize == null ? { x: 0.5, y: 1 } : params.startSize;
      params.startSpeed =
        params.startSpeed == null ? { x: 15, y: 30 } : params.startSpeed;
      params.rotSpeed =
        params.rotSpeed == null ? { x: 120, y: 360 } : params.rotSpeed;
      params.spinSpeed =
        params.spinSpeed == null ? { x: 50, y: 100 } : params.spinSpeed;
      params.fadeInEnd = params.fadeInEnd == null ? 0.1 : params.fadeInEnd;
      params.fadeOutStart =
        params.fadeOutStart == null ? 0.9 : params.fadeOutStart;
      params.startCol =
        params.startCol == null ? { x: 1, y: 1, z: 1, w: 1 } : params.startCol;
      params.gravity = params.gravity == null ? -9.8 : params.gravity;
      params.speedLimit = params.speedLimit == null ? 10000 : params.speedLimit;
      params.speedDamping =
        params.speedDamping == null ? 0 : params.speedDamping;
    ...
    SpawnParticles: function (particles, count, pos, dir) {
      Module.SpawnParticles(particles, count, pos, dir || { x: 0, y: 0, z: 1 });
    },
    ...
    PlayMusic: function (musicId, volume, loop) {
      if (this.__currentMusic != null) {
        ...
        else oldMusic.stop(); // fade-out?
      }

      if (musicId < 0 || musicId >= this.__audioObjects.length) return;
    ...
    PlaySfx: function (sfxId, volume, loop) {
      ...
      else if (state == "loaded") sound.play();
    },
    PauseMusic: function () {
      if (this.__currentMusic != null) this.__currentMusic.pause();
    },
